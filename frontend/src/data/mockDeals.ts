...
export const deals: Deal[] = [
  ...
  // COMPETITOR DEALS - For map visualization
  {
    ...mockDeal,
    id: "competitor-deal-1",
    title: "Save 35% on $50 Toward Mexican Food & Margaritas at Taco Fiesta",
    galleryTitle: "Taco Fiesta - Authentic Mexican Cuisine",
    location: "Taco Fiesta, Chicago",
    accountId: "competitor-1",
    locationIds: getAccountLocationIds("competitor-1"),
    category: "Food & Drink",
    subcategory: "Restaurant",
    status: "Live",
    campaignStage: "won",
    ...
    content: {
      ...mockDeal.content,
      description: "Experience authentic Mexican flavors at Taco Fiesta. Enjoy our signature tacos, fresh guacamole, and handcrafted margaritas in a vibrant atmosphere.",
      media: [
        {
          id: "comp-1-img-1",
          ...
          type: "image",
          score: 88,
          scoreReason: "Vibrant food photography with great composition",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-2",
    title: "40% Off $60 Toward Authentic Mexican Dinner at El Pueblo Mexican Kitchen",
    galleryTitle: "El Pueblo - Family Mexican Recipes",
    location: "El Pueblo Mexican Kitchen, Chicago",
    accountId: "competitor-2",
    locationIds: getAccountLocationIds("competitor-2"),
    category: "Food & Drink",
    subcategory: "Restaurant",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      ...
      {
        id: "comp-2-opt-2",
        name: "$100 Toward Dinner for Four",
        regularPrice: 100,
        grouponPrice: 55,
        discount: 45,
        validity: "Valid for 120 days",
    ...
    content: {
      ...mockDeal.content,
      description: "Discover family recipes passed down through generations at El Pueblo. From enchiladas to carne asada, every dish tells a story.",
      media: [
        {
          id: "comp-2-img-1",
          url: "https://images.unsplash.com/photo-1617343267895-dbe0a727e295?w=800&q=80",
          isFeatured: true,
          type: "image",
          score: 90,
          scoreReason: "Excellent food styling and lighting",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-3",
    title: "Spa Day Package: 50% Off Massage & Facial at Tranquil Spa Retreat",
    galleryTitle: "Tranquil Spa - Luxury Wellness",
    location: "Tranquil Spa Retreat, Chicago",
    accountId: "competitor-3",
    locationIds: getAccountLocationIds("competitor-3"),
    ...
    content: {
      ...mockDeal.content,
      description: "Escape to tranquility with our luxury spa treatments. Expert therapists, premium products, and a serene atmosphere await.",
      media: [
        {
          id: "comp-3-img-1",
          ...
          type: "image",
          score: 86,
          scoreReason: "Calming spa atmosphere captured well",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-4",
    title: "Get Fit: 60% Off 3-Month Gym Membership at PowerFit Gym",
    galleryTitle: "PowerFit - Modern Fitness Center",
    location: "PowerFit Gym, Chicago",
    accountId: "competitor-4",
    locationIds: getAccountLocationIds("competitor-4"),
    category: "Health & Fitness",
    subcategory: "Gym",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      {
        ...
        grouponPrice: 32,
        discount: 60,
        validity: "Valid for 30 days from activation",
        enabled: true,
        merchantMargin: 40,
        grouponMargin: 60,
        merchantPayout: 12.8,
      ...
      },
      {
        ...
        grouponPrice: 89,
        discount: 63,
        validity: "Valid for 90 days from activation",
        enabled: true,
        merchantMargin: 40,
        grouponMargin: 60,
        merchantPayout: 35.6,
      ...
      {
        id: "comp-4-opt-3",
        name: "6-Month Membership + Personal Training",
        regularPrice: 600,
        grouponPrice: 199,
        discount: 67,
        validity: "Valid for 180 days from activation",
        enabled: true,
        merchantMargin: 40,
        grouponMargin: 60,
        merchantPayout: 79.6,
    ...
    content: {
      ...mockDeal.content,
      description: "Transform your fitness journey at PowerFit. State-of-the-art equipment, expert trainers, and motivating group classes.",
      media: [
        {
          id: "comp-4-img-1",
          url: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80",
          ...
          type: "image",
          score: 85,
          scoreReason: "Modern gym equipment and atmosphere",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-5",
    title: "Save 45% on $80 Toward Authentic Italian Dinner at Bella Italia",
    galleryTitle: "Bella Italia - Authentic Italian Cuisine",
    location: "Bella Italia Ristorante, Chicago",
    accountId: "competitor-5",
    locationIds: getAccountLocationIds("competitor-5"),
    category: "Food & Drink",
    subcategory: "Restaurant",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      ...
      {
        id: "comp-5-opt-2",
        name: "$150 Toward Dinner for Four",
        regularPrice: 150,
        grouponPrice: 78,
        discount: 48,
        validity: "Valid for 90 days",
    ...
    content: {
      ...mockDeal.content,
      description: "Experience authentic Italian flavors at Bella Italia. Handmade pasta, wood-fired pizzas, and classic Italian dishes in an elegant setting.",
      media: [
        {
          id: "comp-5-img-1",
          url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&q=80",
          ...
          type: "image",
          score: 89,
          scoreReason: "Beautiful Italian food presentation",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-6",
    title: "30% Off $100 Toward Omakase Experience at Zen Sushi Bar",
    galleryTitle: "Zen Sushi - Fresh Japanese Cuisine",
    location: "Zen Sushi Bar, Chicago",
    accountId: "competitor-6",
    locationIds: getAccountLocationIds("competitor-6"),
    category: "Food & Drink",
    subcategory: "Restaurant",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      {
        id: "comp-6-opt-1",
        name: "$100 Toward Omakase Experience",
        regularPrice: 100,
        grouponPrice: 70,
        discount: 30,
    ...
    content: {
      ...mockDeal.content,
      description: "Indulge in the finest sushi and Japanese cuisine at Zen Sushi Bar. Expert chefs prepare fresh, premium ingredients in an intimate setting.",
      media: [
        {
          id: "comp-6-img-1",
          ...
          type: "image",
          score: 87,
          scoreReason: "Stunning sushi presentation",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-7",
    title: "50% Off 1-Month Unlimited CrossFit Classes at Iron Strength",
    galleryTitle: "Iron Strength - High-Intensity Training",
    location: "Iron Strength CrossFit, Chicago",
    accountId: "competitor-7",
    locationIds: getAccountLocationIds("competitor-7"),
    category: "Health & Fitness",
    subcategory: "Gym",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      {
        id: "comp-7-opt-1",
        name: "1-Month Unlimited Classes",
        regularPrice: 150,
        grouponPrice: 75,
        discount: 50,
        validity: "Valid for 30 days from activation",
        ...
        merchantMargin: 45,
        grouponMargin: 55,
        merchantPayout: 33.75,
        status: "Live",
      },
      {
        id: "comp-7-opt-2",
        name: "3-Month Unlimited Classes",
        regularPrice: 450,
        grouponPrice: 199,
        discount: 56,
        validity: "Valid for 90 days from activation",
    ...
    content: {
      ...mockDeal.content,
      description: "Push your limits with high-intensity CrossFit training at Iron Strength. Certified coaches guide you through challenging workouts.",
      media: [
        {
          id: "comp-7-img-1",
          ...
          type: "image",
          score: 84,
          scoreReason: "Dynamic CrossFit training scene",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-8",
    title: "55% Off Spa Day Package: Massage & Facial at Serenity Day Spa",
    galleryTitle: "Serenity Day Spa - Relaxation & Wellness",
    location: "Serenity Day Spa, Chicago",
    accountId: "competitor-8",
    locationIds: getAccountLocationIds("competitor-8"),
    category: "Beauty & Spas",
    subcategory: "Spa",
    status: "Live",
    campaignStage: "won",
    ...
    content: {
      ...mockDeal.content,
      description: "Escape the hustle and unwind at Serenity Day Spa. Professional therapists provide rejuvenating massages and skincare treatments.",
      media: [
        {
          id: "comp-8-img-1",
          ...
          type: "image",
          score: 83,
          scoreReason: "Serene spa atmosphere",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-9",
    title: "Save 40% on $75 Toward BBQ Feast at BBQ Smokehouse",
    galleryTitle: "BBQ Smokehouse - Authentic Texas BBQ",
    location: "BBQ Smokehouse, Chicago",
    accountId: "competitor-9",
    locationIds: getAccountLocationIds("competitor-9"),
    category: "Food & Drink",
    subcategory: "Restaurant",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      ...
      {
        id: "comp-9-opt-2",
        name: "$140 Toward BBQ Feast for Four",
        regularPrice: 140,
        grouponPrice: 78,
        discount: 44,
        validity: "Valid for 90 days",
    ...
    content: {
      ...mockDeal.content,
      description: "Savor authentic Texas-style BBQ at BBQ Smokehouse. Slow-smoked meats, homemade sides, and classic barbecue flavors.",
      media: [
        {
          id: "comp-9-img-1",
          ...
          type: "image",
          score: 91,
          scoreReason: "Mouthwatering BBQ presentation",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-10",
    title: "40% Off 10-Class Yoga Pass at Yoga Flow Studio",
    galleryTitle: "Yoga Flow - Vinyasa & Hot Yoga",
    location: "Yoga Flow Studio, Chicago",
    accountId: "competitor-10",
    locationIds: getAccountLocationIds("competitor-10"),
    category: "Health & Fitness",
    subcategory: "Yoga",
    status: "Live",
    campaignStage: "won",
    ...
    content: {
      ...mockDeal.content,
      description: "Find your flow at Yoga Flow Studio. Vinyasa and hot yoga classes in a peaceful, welcoming environment.",
      media: [
        {
          id: "comp-10-img-1",
          ...
          type: "image",
          score: 82,
          scoreReason: "Peaceful yoga studio setting",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-11",
    title: "35% Off $50 Toward Gourmet Burgers & Craft Beer at The Burger Joint",
    galleryTitle: "The Burger Joint - Gourmet Burgers",
    location: "The Burger Joint, Chicago",
    accountId: "competitor-11",
    locationIds: getAccountLocationIds("competitor-11"),
    category: "Food & Drink",
    subcategory: "Restaurant",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      {
        ...
        merchantMargin: 62,
        grouponMargin: 38,
        merchantPayout: 19.84,
        status: "Live",
      },
      {
        id: "comp-11-opt-2",
        name: "$90 Toward Dinner for Two",
        regularPrice: 90,
        grouponPrice: 55,
        discount: 39,
        validity: "Valid for 60 days",
    ...
    content: {
      ...mockDeal.content,
      description: "Indulge in gourmet burgers made with premium ingredients at The Burger Joint. Pair with craft beer and hand-cut fries.",
      media: [
        {
          id: "comp-11-img-1",
          url: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80",
          ...
          type: "image",
          score: 88,
          scoreReason: "Appetizing burger photography",
        },
      ],
    },
  },
  {
    ...mockDeal,
    id: "competitor-deal-12",
    title: "65% Off 3-Month Premium Membership + Personal Training at Elite Fitness",
    galleryTitle: "Elite Fitness - Premium Training Center",
    location: "Elite Fitness Center, Chicago",
    accountId: "competitor-12",
    locationIds: getAccountLocationIds("competitor-12"),
    category: "Health & Fitness",
    subcategory: "Gym",
    status: "Live",
    campaignStage: "won",
    ...
    options: [
      ...
      {
        id: "comp-12-opt-2",
        name: "3-Month Premium + 2 Personal Training Sessions",
        regularPrice: 500,
        grouponPrice: 175,
        discount: 65,
        validity: "Valid for 90 days from activation",
    ...
    content: {
      ...mockDeal.content,
      description: "Achieve your fitness goals at Elite Fitness Center. Premium equipment, expert personal trainers, and comprehensive fitness programs.",
      media: [
        {
          id: "comp-12-img-1",
          url: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80",
          ...
          type: "image",
          score: 86,
          scoreReason: "Premium fitness facility showcase",
        },
      ],
    },
  },
