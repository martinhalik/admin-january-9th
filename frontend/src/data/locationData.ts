...
export const mockLocations: { [accountId: string]: Location[] } = {
  ...
  // COMPETITOR LOCATIONS - For map visualization
  "competitor-1": [
    {
      id: "comp-loc-1-1",
      name: "Taco Fiesta - West Loop",
      address: {
        street: "150 West Madison Street",
        city: "Chicago",
        state: "IL",
        zipCode: "60602",
        country: "USA",
      ...
      isActive: true,
      businessType: "Restaurant",
      description: "Competitor Mexican restaurant with tacos and margaritas",
  ...
  "competitor-2": [
    {
      id: "comp-loc-2-1",
      name: "El Pueblo Mexican Kitchen - Loop",
      address: {
        street: "180 West Madison Street",
        city: "Chicago",
        state: "IL",
        zipCode: "60602",
        country: "USA",
  ...
  "competitor-3": [
    {
      id: "comp-loc-3-1",
      name: "Tranquil Spa Retreat - Chicago",
      address: {
        street: "250 Wellness Ave",
        city: "Chicago",
        state: "IL",
        zipCode: "60602",
        country: "USA",
      ...
      isActive: true,
      businessType: "Spa & Beauty",
      description: "Luxury spa services and wellness treatments",
  ...
  "competitor-4": [
    {
      ...
      address: {
        street: "2300 North Clybourn Avenue",
        city: "Chicago",
        state: "IL",
        zipCode: "60614",
        country: "USA",
      ...
      phone: "(555) 444-5555",
      email: "downtown@powerfitgym.com",
  ...
  "competitor-5": [
    {
      id: "comp-loc-5-1",
      name: "Bella Italia Ristorante - Loop",
      address: {
        street: "120 North State Street",
        city: "Chicago",
        state: "IL",
        zipCode: "60602",
        country: "USA",
  ...
  "competitor-6": [
    {
      id: "comp-loc-6-1",
      name: "Zen Sushi Bar - Magnificent Mile",
      address: {
        street: "350 North Michigan Avenue",
        city: "Chicago",
        state: "IL",
        zipCode: "60611",
        country: "USA",
  ...
  "competitor-7": [
    {
      id: "comp-loc-7-1",
      name: "Iron Strength CrossFit - Lincoln Park",
      address: {
        street: "1800 West Fullerton Avenue",
        city: "Chicago",
        state: "IL",
        zipCode: "60614",
        country: "USA",
      ...
      phone: "(555) 777-8888",
      email: "lincolnpark@ironstrength.com",
  ...
  "competitor-8": [
    {
      id: "comp-loc-8-1",
      name: "Serenity Day Spa - South Loop",
      address: {
        street: "500 South Wabash Avenue",
        city: "Chicago",
        state: "IL",
        zipCode: "60605",
        country: "USA",
      ...
      phone: "(555) 888-9999",
      email: "southloop@serenityspa.com",
      website: "www.serenityspa.com",
      hours: {
        monday: { open: "09:00", close: "19:00", isClosed: false },
        tuesday: { open: "09:00", close: "19:00", isClosed: false },
      ...
      isActive: true,
      businessType: "Spa & Beauty",
      description: "Full-service day spa treatments",
  ...
  "competitor-9": [
    {
      id: "comp-loc-9-1",
      name: "BBQ Smokehouse - West Loop",
      address: {
        street: "800 West Randolph Street",
        city: "Chicago",
        state: "IL",
        zipCode: "60607",
        country: "USA",
      ...
      phone: "(555) 999-0000",
      email: "westloop@bbqsmokehouse.com",
      ...
      isActive: true,
      businessType: "Restaurant",
      description: "Authentic Texas-style BBQ",
  ...
  "competitor-10": [
    {
      id: "comp-loc-10-1",
      name: "Yoga Flow Studio - River North",
      address: {
        street: "600 North Clark Street",
        city: "Chicago",
        state: "IL",
        zipCode: "60654",
        country: "USA",
      ...
      isActive: true,
      businessType: "Fitness & Health",
      description: "Vinyasa and hot yoga classes",
  ...
  "competitor-11": [
    {
      id: "comp-loc-11-1",
      name: "The Burger Joint - Gold Coast",
      address: {
        street: "900 North State Street",
        city: "Chicago",
        state: "IL",
        zipCode: "60610",
        country: "USA",
      ...
      phone: "(555) 111-2223",
      email: "goldcoast@burgerjoint.com",
      ...
      isActive: true,
      businessType: "Restaurant",
      description: "Gourmet burgers with craft beer",
  ...
  "competitor-12": [
    {
      id: "comp-loc-12-1",
      name: "Elite Fitness Center - South Loop",
      address: {
        street: "1400 South Michigan Avenue",
        city: "Chicago",
        state: "IL",
        zipCode: "60605",
        country: "USA",
      ...
      phone: "(555) 222-3334",
      email: "southloop@elitefitness.com",
