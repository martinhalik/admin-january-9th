-- Fix: Drop ALL versions of search_services and recreate with correct signature
-- Run this in Supabase SQL Editor

-- Drop all existing versions
DROP FUNCTION IF EXISTS search_services(TEXT, UUID, INTEGER);
DROP FUNCTION IF EXISTS search_services(TEXT, UUID, UUID, INTEGER);
...
-- Test it immediately
SELECT service_name, category_name, subcategory_name 
FROM search_services('oil', NULL, 5);
